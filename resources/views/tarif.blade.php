              ...
              <tbody>
                @foreach ($data as $item)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('edittarif', $id = $item->id) }}"><button class="btn btn-warning">Update Button</button></a>
                      <a href="{{ route('deletetarif', $id = $item->id) }}"><button class="btn btn-danger">Delete Button</button></a>
                    </td>
                  </tr>
                @endforeach
            </table>
