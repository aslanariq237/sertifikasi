            ...
            <form method="POST" action="{{ route('savetarif')}}" id="quickForm">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="daya" class="form-control" id="daya" placeholder="Masukkan Daya Listrik">
                </div>
                <div class="form-group">
                  <label for="harga">Tarif Per Kwh</label>
                  <input type="text" name="tarifperkwh" class="form-control" id="harga" placeholder="Masukkan Tarif Daya">
                </div>
              </div>
              <!-- /.card-body -->
